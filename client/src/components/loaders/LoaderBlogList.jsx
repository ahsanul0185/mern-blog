  ...
  return (
    <div className='w-full h-full flex flex-col gap-5'>
        {new Array(6).fill(0).map((_, idx) => (
            <div style={{ animationDelay: `${idx * 200}ms` }} key={idx} className='relative bg-gray-200 dark:bg-primaryDark w-full h-22 md:h-32 rounded p-3 flex gap-4 animate-pulse  dark:border border-gray-300 dark:border-gray-200/40'>
