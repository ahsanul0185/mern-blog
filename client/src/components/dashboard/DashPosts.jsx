  ...
  return (
    <div className="relative min-w-[580px] flex gap-4 bg-white/10 items-center p-2.5 rounded group border border-gray-300 dark:border-gray-200/20">
      <img
        ...
        src={coverImage || null}
        className="w-16 md:w-26 aspect-square rounded cursor-pointer object-cover"
        alt="blog image"
        loading="lazy"
      />
      <div className="grow flex flex-col items-start gap-1">
        ...
        <div className="flex text-[10px] md:text-xs gap-3">
          <span className="text-[10px] md:text-xs bg-gray-300/50 dark:bg-white/10 px-1.5 py-0.5 rounded block">
            Updated : {formattedDate}
          </span>
          <span className="w-[1px] bg-gray-300 dark:bg-white/10"></span>
          <span className="px-1.5 py-0.5 text-[10px] md:text-xs text-gray-600 dark:text-gray-300 font-semibold">
