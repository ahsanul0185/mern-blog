...
const DashSidebar = () => {
  ...
  return (
    <div
      ...
      } duration-300 md:h-[calc(100vh-67px)] md:sticky top-[61px] lg:top-[67px] left-0 dark:bg-primaryDark shrink-0 border-b-gray-200 border-b md:border-b-0 border-r-0 dark:border-b-gray-200/40 md:border-r md:border-r-gray-200 dark:border-r-gray-200/40 px-4 py-6`}
    >
