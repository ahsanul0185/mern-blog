...
//     <div
//       className={`${
//         expended ? "md:w-72" : "md:w-20"
//       } duration-300 md:h-[calc(100vh-67px)] md:sticky z-[9999] top-[61px] lg:top-[67px] left-0 dark:bg-primaryDark shrink-0 border-b-gray-200 border-b md:border-b-0 border-r-0 dark:border-b-gray-200/40 md:border-r md:border-r-gray-200 dark:border-r-gray-200/40 px-4 py-6`}
//     >
//       <div className="absolute left-1/2 -translate-x-1/2 top-8 w-full">
//         <img
//           src={currentUser.profilePicture}
//           alt="profile"
//           className={`${expended ? "size-16 md:size-20" : "size-8 md:size-12"} mx-auto rounded-full object-cover duration-300`}
//         />
//         <motion.p initial={{opacity : 0}} animate={{opacity : expended ? 1 : 0}} transition={{delay: expended ? 0.3 : 0, duration : expended ? 0.3 : 0 }} className="text-center font-semibold text-gray-500 dark:text-gray-300 mt-3 text-sm md:text-base">
//           {currentUser.email}
//         </motion.p>
//       </div>

//       <div className="flex flex-col gap-3 mt-40 text-sm md:text-base overflow-hidden">
...
//               }`}
//             >
//               <span className="shrink-0">{item.icon}</span> <span className={`${expended ? "opacity-100" : "opacity-0"} duration-300`}>{item.title}</span>
//             </Link>
//           </div>
//         ))}
...
//         >
//           <BiLogOutCircle className="text-xl shrink-0" /> <span className={`${expended ? "opacity-100" : "opacity-0"} duration-300`}>Sign Out</span>
//         </button>
//       </div>
